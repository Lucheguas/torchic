# Documento de Requerimientos: Player Core Movement

## Introducción

Este documento define los requerimientos del sistema de movimiento principal del jugador para el platformer 2D "Torchic", desarrollado en Godot 4.x con GDScript. El sistema abarca movimiento horizontal con aceleración/desaceleración, salto variable, gravedad, mecánica de pisotón con rebote, coyote time, input buffering, y un sistema de modificadores de velocidad que soportará equipamiento futuro. El estilo visual es pixel art (estética Pokémon Esmeralda) en un side-scroller 2D.
...
- **Acceleration**: Tasa de incremento de velocidad horizontal por frame al mantener una dirección de movimiento.
- **Deceleration**: Tasa de decremento de velocidad horizontal por frame al soltar la dirección de movimiento (fricción).
...
### Requerimiento 1: Movimiento Horizontal

**User Story:** Como jugador, quiero mover al personaje a la izquierda y a la derecha con aceleración y desaceleración suave, para que el control se sienta responsivo y preciso.

#### Criterios de Aceptación

1. WHEN el jugador presiona la dirección izquierda o derecha, THE Movement_Controller SHALL acelerar al Player_Character en la dirección indicada aplicando la tasa de Acceleration hasta alcanzar la Effective_Speed máxima.
2. WHEN el jugador suelta la dirección de movimiento, THE Movement_Controller SHALL desacelerar al Player_Character aplicando la tasa de Deceleration hasta que la velocidad horizontal sea cero.
3. THE Movement_Controller SHALL calcular la Effective_Speed como la suma de Base_Speed y Speed_Modifier.
4. WHILE el Player_Character se encuentra en Air_State, THE Movement_Controller SHALL permitir el control horizontal con una tasa de Acceleration reducida respecto al Ground_State.
5. WHEN el jugador cambia de dirección horizontal sin soltar la entrada previa, THE Movement_Controller SHALL aplicar la Deceleration antes de acelerar en la nueva dirección.

### Requerimiento 2: Salto con Altura Variable
...
### Requerimiento 3: Gravedad y Caída
...
### Requerimiento 4: Mecánica de Pisotón con Rebote
...
### Requerimiento 6: Input Buffering para Salto
...
### Requerimiento 7: Evento de Aterrizaje
...
### Requerimiento 8: Sistema de Modificadores de Velocidad
...
### Requerimiento 9: Escalado de Velocidad Base por Nivel
